...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewerController : Controller
    {
        ...
        public IActionResult UpdateCategory(int reviewerId,
            [FromBody] ReviewerDto updateReviewer)
        {
            ...
            var categoryMap = _mapper.Map<Reviewer>(updateReviewer);

            if (!_reviewerRepository.UpdateReviewer(categoryMap))
            {
